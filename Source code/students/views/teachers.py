...
class TeacherQuizListView(ListView):
    ...
    def get_queryset(self):
        queryset = self.request.user.quizzes.select_related('course').annotate(questions_count=Count('questions', distinct=True)).annotate(taken_count=Count('taken_quizzes', distinct=True))
        return queryset
